...
QT_MOC_LITERAL(5, 48, 16), // "clientDisConnect"
QT_MOC_LITERAL(6, 65, 10), // "myReadData"
QT_MOC_LITERAL(7, 76, 12) // "myDisConnect"

    },
    "MyTcpSocket\0clientReadData\0\0MyTcpSocket*\0"
    "socket\0clientDisConnect\0myReadData\0"
    "myDisConnect"
};
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->clientDisConnect((*reinterpret_cast< MyTcpSocket*(*)>(_a[1]))); break;
        case 2: _t->myReadData(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTcpSocket::clientReadData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::clientReadData(MyTcpSocket * _t1)
{
...
// SIGNAL 1
void MyTcpSocket::clientDisConnect(MyTcpSocket * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
