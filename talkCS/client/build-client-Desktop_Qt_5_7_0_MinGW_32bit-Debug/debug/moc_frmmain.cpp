...
QT_MOC_LITERAL(1, 8, 19), // "sendMessageToFriend"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4), // "data"
QT_MOC_LITERAL(4, 34, 10), // "judgeState"
QT_MOC_LITERAL(5, 45, 18), // "afterTalkWinClosed"
QT_MOC_LITERAL(6, 64, 4), // "name"
QT_MOC_LITERAL(7, 69, 14) // "emitSendSignal"

    },
    "FrmMain\0sendMessageToFriend\0\0data\0"
    "judgeState\0afterTalkWinClosed\0name\0"
    "emitSendSignal"
};
...
void FrmMain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMessageToFriend((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->judgeState(); break;
        case 2: _t->afterTalkWinClosed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->emitSendSignal((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (FrmMain::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrmMain::sendMessageToFriend)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FrmMain::sendMessageToFriend(QByteArray _t1)
{
